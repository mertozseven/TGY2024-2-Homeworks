//
//  SenderNotificationViewController.swift
//  25-03-2024-homework
//
...
class SenderNotificationViewController: UIViewController {
    ...
    @objc func sendDataButtonAction() {
        ...
        NotificationCenter.default.post(name: Notification.Name("MessageNotification"), object: text)
