//
//  ListenerNotificationViewController.swift
//  25-03-2024-homework
//
...
class ListenerNotificationViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(receiveMessage), name: Notification.Name("MessageNotification"), object: nil)
    }
    ...
    @objc func getDataButonAction() {
        print("button tapped")
        let senderVC = SenderNotificationViewController()
