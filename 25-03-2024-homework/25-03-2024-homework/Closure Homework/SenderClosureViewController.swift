//
//  SenderClosureViewController.swift
//  25-03-2024-homework
//
...
class SenderClosureViewController: UIViewController {
    ...
    private func configureView() {
        let textFieldConstraints = [ textField.centerXAnchor.constraint(equalTo: view.centerXAnchor), textField.centerYAnchor.constraint(equalTo: view.centerYAnchor), textField.widthAnchor.constraint(equalTo: view.safeAreaLayoutGuide.widthAnchor, constant: -16), textField.heightAnchor.constraint(equalToConstant: 50)
        ]
